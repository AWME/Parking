...
return [
    'plugin' => [
        'name' => 'Parking',
        'description' => 'Software de administración de playa de estacionamiento'
    ],
    ...
    'tills' => [
        ...
        'sale'          => 'Venta de Parking',
        'sale_subs'     => 'Pago de Abono',
        'withdrawal'    => 'Retiro de Dinero',
        'summary'       => 'Resumen de caja',

        'total_deposites'       => 'Ingresos de dinero',
        'total_witdrawls'       => 'Retiros de dinero',
        'total_parking_sales'   => 'Ventas de Parking',
        'total_subscription'    => 'Pagos de Abono',
        'total_all_sales'       => 'Total de Ventas',
        'total_income'          => 'Ingresos Totales',
        'total_in_till'         => 'Total en Caja',
        ...
        'closed_successfully'       => 'Cierre de caja realizado con éxito.',
